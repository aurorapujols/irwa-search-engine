...
#         for doc_idx, (field, postings) in enumerate(index[q_term].items()):
...
# def search(query, index, tf, idf, weights, index2title):
#     """
...
#     docs = list(docs)
#     ranked_docs = rank_tf_idf(query, docs, index, tf, idf, weights)
